...
def impulse_gen(num_samples,delay,upsample=10,freq_response=2600000000.0,low_corner_freq=250000000.0,high_corner_freq=900000000.0,order=8,draw_flag=0,output_dir='output/'):
