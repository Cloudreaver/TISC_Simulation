...
def impulse_gen(num_samples,delay,upsample=10,freq_response=2600000000.0,low_corner_freq=132000000.0,high_corner_freq=1300000000.0,order=4,draw_flag=0,output_dir='output/'):
    ...
    signal_temp = ifft(h,num_samples)
    
    upsample_signal_temp = sinc_interp(signal_temp,time,upsample_time)
    ...
    for t in range(0,num_samples):
        signal_temp[t] = upsample_signal_temp[t*upsample+phase]#/(0.1*(t+1)**2)
    ...
    #print random_delay
    signal[random_delay:num_samples] = signal_temp[0:num_samples-random_delay]
