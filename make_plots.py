...
if __name__ == '__main__':
	...
	if (cw_flag):
		cw_sample = generate_cw(sample_length=sample_length,sample_frequency=sample_frequency,carrier_frequency=carrier_frequency,modulation_frequency=modulation_frequency,peak_amplitude=peak_amplitude,filter_flag=1)
	...
	b_digitized_sample = digitize(b_impulse_noise_sample,sample_length,upsample=1,num_bits=3,noise_mean=0.0,noise_rms=20,digitization_factor=1)
	c_digitized_sample = digitize(c_impulse_noise_sample,sample_length,upsample=1,num_bits=3,noise_mean=0.0,noise_rms=20,digitization_factor=1)
	plt.figure(8)
	plt.clf()
