   ...
   for SNR_counter in range(0,len(SNR)):
      ...
      for threshold_counter in range(0,len(threshold)):
         for runNum in range(0,num_runs):
            ...
            event_passed_flag = 0
            event_passed_flag = sum_correlation(SNR[SNR_counter],threshold[threshold_counter],a_input_signal,b_input_delay,c_input_delay,upsample=upsample,num_samples=num_samples,draw_flag=draw_flag,digitization_factor=digitization_factor,output_dir=output_dir)
