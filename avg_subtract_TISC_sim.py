...
#################################
   ...
   if cw_flag:
      a_input_noise = np.add(a_input_noise,generate_cw(num_samples,upsample,sample_freq,carrier_frequency,modulation_frequency,peak_amplitude,filter_flag))

      b_input_noise = np.add(b_input_noise,generate_cw(num_samples,upsample,sample_freq,carrier_frequency,modulation_frequency,peak_amplitude,filter_flag))

      c_input_noise = np.add(c_input_noise,generate_cw(num_samples,upsample,sample_freq,carrier_frequency,modulation_frequency,peak_amplitude,filter_flag))
...
if __name__ == '__main__':
   ...
   passedFlag, max_sum = avg_subtract_TISC_sim(SNR,threshold,impulse_position,b_input_delay,c_input_delay,num_bits=num_bits,
